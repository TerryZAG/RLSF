...
def main(config, fold_id):
    ...
    batch_size = config["data_loader"]["args"]["batch_size"]  # 128
    ...
    print("weights_for_each_class: ", weights_for_each_class)
...
if __name__ == '__main__':
    ...
    args.add_argument('-f', '--fold_id', type=str,
                      help='fold_id', default="0")
    args.add_argument('-da', '--np_data_dir', type=str,
                      help='Directory containing numpy files', default="data/sleep_stage_data_tgam")
